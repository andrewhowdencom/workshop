...
//
// A subagent.SubagentDefinition is wrapped in a (tool.Tool, tool.ToolFunc)
// pair via x/subagent.AsTool and registered into the parent's tool.Registry.
// The LLM picks the sub-agent by emitting a tool call.
//
