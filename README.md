...
Workshop exposes **sub-agents** as declarative agent definitions that the
parent agent can call mid-turn as tools. Each invocation runs a fresh
`*agent.Agent` against an isolated conversation thread and returns a
